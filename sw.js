...
const CACHE = 'hr7-eleven-v135';      // v135: แก้รวมยอดขาย (สิ้นวัน/บวก 3 ผลัด) · โดนัทไม่นับซ้ำ · เตือนรอบก่อนหน้ายังไม่ปิด · ประตูรหัสเงินเดือน · กันลงเวลาผิดวันกะข้ามคืน 4 ชั้น
